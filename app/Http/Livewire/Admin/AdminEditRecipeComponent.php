...
class AdminEditRecipeComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.admin.admin-edit-recipe-component', ['categories' => $categories, 'selected_ingredients' => $a, 'all_ingredients' => $all_ingredients])->layout('layouts.base');
    }
}
