    ...
    <div class="pt-4 bg-gray-100">
        <div class="min-h-screen flex flex-col items-center pt-6 sm:pt-0">
            <div class="w-full sm:max-w-2xl mt-6 mb-6 p-6 bg-white shadow-md overflow-hidden sm:rounded-lg prose">
                ...
                <p>At <u>Website Name</u>, accessible at <u>Website.com</u>, one of our main priorities is the privacy 
                    of our visitors. This Privacy Policy document contains types of information that is collected 
                    and recorded by <u>Website Name</u> and how we use it.
                </p>
                <p>If you have additional questions or require more information about our Privacy Policy, 
                    do not hesitate to contact us through email at <u>Email@Website.com</u>
                </p>
                <p>This privacy policy applies only to our online activities and is valid for visitors to our website 
                    with regards to the information that they shared and/or collect in Website Name. 
                    This policy is not applicable to any information collected offline or via channels other than this website.
                </p>

                <b class="text-xl">Consent</b>
                <p>By using our website, you hereby consent to our Privacy Policy and agree to its terms.</p>

                <b class="text-xl">Information we collect</b>
                ...
                <b class="text-xl">How we use your information</b>
                ...
                <b class="text-xl">Log Files</b>
                <p><u>Website Name</u> follows a standard procedure of using log files. These files log visitors when they visit websites. 
                ...
                <b class="text-xl">Cookies and Web Beacons</b>
                <p>Like any other website,<u>Website Name</u> uses ‘cookies'. These cookies are used to store information including visitors' 
                ...
                <b class="text-xl">Advertising Partners Privacy Policies</b>
                <p>You may consult this list to find the Privacy Policy for each of the advertising partners of <u>Website Name</u> </p>
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are 
                    used in their respective advertisements and links that appear on <u>Website Name</u>, which are sent directly to users' browser. 
                ...
                <p>Note that <u>Website Name</u> has no access to or control over these cookies that are used by third-party advertisers.</p>

                <b class="text-xl">Third-Party Privacy Policies</b>
                <p><u>Website Name's</u> Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to 
                ...
                <b class="text-xl">CCPA Privacy Policy (Do Not Sell My Personal Information)</b>
                ...
                <b class="text-xl">GDPR Privacy Policy (Data Protection Rights)</b>
                ...
                <b class="text-xl">Children's Information</b>
                ...
                <p>Website Name does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your 
